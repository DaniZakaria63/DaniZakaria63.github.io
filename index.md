...
Application architecture and business process in mobile android aspect are often people to speak about. Now I want you to review mine and please give your opinion about it. Surely the best source for android architecture is the official [android](https://developer.android.com) documentation by google. But the real-world case always kinda different, right? So that's why I try to write [thought](./thought) section.


Although those information are subjective due to my experience only, but trust me guys I've been searching about on-device or architecture topic for years now. That things give me convident to show to you now. Please check on that.
